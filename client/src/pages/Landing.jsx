...
const Landing = () => {
    ...
    return (
        <>
            <div className='grid md:grid-cols-2 justify-items-center gap-10 items-center font-main font-bold text-3xl h-96'>
                <div className='bg-emerald-700 hidden md:block w-full h-full shadow-lg shadow-black/50 rounded'></div>
                <div>
            ...
            <div className='border-2 border-solid border-emerald-700 text-center mt-10'>
                ...
                <div className='grid grid-cols-1 pb-2 items-center'>
