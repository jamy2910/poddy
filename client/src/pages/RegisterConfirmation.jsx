...
const RegisterConfirmation = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center h-60 mb-60'>
            ...
            <h3 className='text-center text-xl'>Welcome to Poddy. We have sent you a confirmation email. Verify your email to continue. <span onClick={() => navigate('/login')} className='text-emerald-700 hover:underline cursor-pointer'>Click here to login</span></h3>
