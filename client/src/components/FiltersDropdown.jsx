...
const FiltersDropdown = ({ live, filterFunction, updateFilters }) => {
    ...
    <div className='text-center mt-4'>
      ...
      {open && <div className='border-solid border-b-2 border-0 border-emerald-700 pb-3'>
        <div className='mt-4 grid grid-cols-3 items-center box-border p-4'>
          ...
          {!live && <FilterSelectInput options={['Past 24 hours', 'Last 7 days', 'Last month']} title={'Date posted'} name={'live'} />}
        </div>
